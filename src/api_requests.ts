...
export async function fetchOneAnimal(id: string): Promise<[number, Artwork]> { 
    ...
    const animal: Artwork = result as Artwork
...
function isAnimal(obj: any): obj is Artwork {
    return obj && 
        typeof obj.id === 'string' &&
        typeof obj.name === 'string' &&
        typeof obj.sciName === 'string' &&
        Array.isArray(obj.description) && obj.description.every((desc: any) => typeof desc === 'string') &&
        Array.isArray(obj.images) && obj.images.every((img: any) => typeof img === 'string') &&
        Array.isArray(obj.events) && obj.events.every(isAnimalEvent) &&
        typeof obj.createdByUser === 'string'
}

// Helper function to check if an object is of type AnimalEvent
function isAnimalEvent(obj: any): obj is AnimalEvent {
    return obj && 
        typeof obj.name === 'string' &&
